...
class ___VARIABLE_moduleName___Assembly {
  ...
  static func createModule(moduleIn: ___VARIABLE_moduleName___.DataContext.ModuleIn) -> ___VARIABLE_moduleName___ViewController {
    let controller = UIStoryboard(name: storyboardId, bundle: nil).instantiateViewController(withIdentifier: controllerStoryboardId) as! ___VARIABLE_moduleName___ViewController
  ...
  fileprivate static func injectInteractor() -> ___VARIABLE_moduleName___InteractorInput {
    ...
    return ___VARIABLE_moduleName___Interactor(service: service)
  }
  fileprivate static func injectService() -> ___VARIABLE_moduleName___ServiceProtocol {
    return ___VARIABLE_moduleName___Service(reporter: nil)
  }
